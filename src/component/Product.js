...
function Product() {
  ...
  return (
    <div className='p-bg'>
      ...
      <div className='p-sec-1'>
        <h4>OUR PRODUCTS</h4>
        <h1>Let the fresh taste shine.</h1>
        <div className='sec-3'>
          <video src='/img/product-p.mp4' playsInline autoPlay loop muted></video>
        </div>
      </div>
      ...
      <div className='sec-8'>
        ...
        <div className='sec-2'>
          <div>
            <h1>Tropicana Pure Premium<sup>®</sup></h1>
          </div>
          <div>
            <h2>
              Every glass is brimming with Vitamin C. A refreshing <br /> taste of pure sunshine.</h2>
          </div>
        </div>
      </div>

      <div className='sec-2-2 p-sec-3 row'>
        {data.productItems1.map(product => (
          <div key={product.id} className='col-md-4'>
            ...
            <div>
              <Link to="/cart">
                <button type='button' onClick={() => addToCartPro(product)}>Add Cart</button>
              </Link>
            </div>
          </div>
        ))}
      ...
      <div className='p-sec-4 sec-5'>
        <img src="/img/tropicana-lifestyle-kitchen-open-shelving-shot-6-1287-2560.jpg" alt="header" style={{ width: "816px", height: "612px", position: "absolute", right: "30px" }} />
        <img src="/img/download.png" alt="header" style={{ width: "180px", height: "180px", position: "absolute", right: "-40px", top: "160px" }} />
        <img src="/img/juice-overhead-classic-orange-960.png" alt="header" style={{ width: "472px", height: "472px", position: "absolute", right: "600px", bottom: "0px" }} />
        <h2 style={{ position: "absolute", right: "50px", top: "840px" }} >There's nothing like that first sip of sunshine in the <br /> morning. It's rise and shine in a bottle.</h2>
        <div className='p-sec-5' style={{ position: "absolute", left: "50px", top: "30px" }} >
          <h1>Sip Your Sunshine</h1>
          <h1>Sip Your Sunshine</h1>
          <h1>Sip Your Sunshine</h1>
        </div>
      </div>

      <div className='sec-8 h-Light'>
        <div className='sec-2'>
          <div>
            <h1>Tropicana Light<sup>®</sup></h1>
          </div>
          <div>
            <h2>
              50% less sugar, 50% fewer calories than regular orange <br /> juice. 100% great taste. </h2>
          </div>
        </div>
      </div>

      <div className='sec-2-2 p-sec-3 row'>
        {data.productItems2.map(product => (
          <div key={product.id} className='col-md-4'>
            <div className='f-sec-2-2 p-sec-2-2'>
              <div>
                <img src={product.image} alt={product.name} />
              </div>
            </div>
      ...
      <div className='sec-5 p-taste'>
        <img src="/img/download.png" alt="header" style={{ width: "180px", height: "180px", position: "absolute", left: "90px", top: "80px" }} />
        <div>
          <img src="/img/tropicana-lifestyle-kitchen-open-shelving-shot-8-3-4-2560.jpg" alt="header" style={{ width: "825px", height: "619px" }} />
        </div>
        <h2>50% less sugar, 50% few calories than regular orange <br /> juice. New name, 100% great taste.</h2>
        <img src="/img/juice-overhead-classic-orange-960.png" alt="header" style={{ width: "472px", height: "472px", position: "absolute", right: "250px", bottom: "90px" }} />
        <div className='p-sec-5' style={{ position: "absolute", right: "50px", top: "-40px" }} >
          <h1>New Name, Same Great Taste</h1>
          <h1>New Name, Same Great Taste</h1>
          <h1>New Name, Same Great Taste</h1>
        </div>
      </div>

      <div className='sec-8 h-Premium'>
        <div className='sec-2'>
          <div>
            <h1>Tropicana Premium Drinks<sup>®</sup></h1>
          </div>
          <div>
            <h2>
              Welcome to a refreshing and delicious rainbow of flavors. <br /> It's summer in a bottle.</h2>
          </div>
        </div>
      </div>
      ...
      <div className='sec-2-2 p-sec-3 row'>
        {data.productItems3.map(product => (
          <div key={product.id} className='col-md-4'>
            <div className='f-sec-2-2 p-sec-2-3'>
              <div>
                <img src={product.image} alt={product.name} />
              </div>
            </div>
      ...
      <div className='sec-5 p-taste'>
        <img src="/img/download.png" alt="header" style={{ width: "180px", height: "180px", position: "absolute", left: "90px", top: "80px" }} />
        <div>
          <img src="/img/tropicana-lifestyle-outdoor-table-shot-4-0219-1280.jpg" alt="header" style={{ width: "825px", height: "619px" }} />
        </div>
        <h2>50% less sugar, 50% few calories than regular orange <br /> juice. New name, 100% great taste.</h2>
        <img src="/img/juice-overhead-vibrant-color-ice-1280.png" alt="header" style={{ width: "472px", height: "472px", position: "absolute", right: "250px", bottom: "90px" }} />
        <div className='p-sec-5' style={{ position: "absolute", right: "200px", top: "18px" }} >
          <h1>Mid-Day Delight</h1>
          <h1>Mid-Day Delight</h1>
          <h1>Mid-Day Delight</h1>
        </div>
      </div>
