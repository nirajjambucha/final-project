...
function SignUpPage() {
    ...
    const handleSubmit = (e) => {
        ...
        if (formData.password !== formData.confirmPassword) {
            newErrors.confirmPassword = ' ⚠️ Password and confirm password must match!';
        }

        setErrors(newErrors);

        if (Object.keys(newErrors).length === 0) {
            const existingUserData = JSON.parse(localStorage.getItem('formData')) || [];
    ...
    return (
        <>
            <nav>
                ...
                <div>
                    <a href=""><svg style={{ width: "118px", height: "40px" }} viewBox="0 0 118 40" fill="none"
                ...
                <div className="r-heder" style={{ position: "relative" }}>
                    ...
                    <i className="fa fa-search landing-search" ></i>
                    <a href='/signin'><button className='sign-up'>sign up</button></a>
